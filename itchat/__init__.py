...
##leechen2014 add
def get_contractTest(update=False): return __client.get_contractTest(update)


##
def get_QRTest(uuid=None): return __client.get_QRTest(uuid)


def get_QRTest2(uuid=None): return __client.get_QRTest2(uuid)  # get_QRTest2
...
def delete_member_from_chatroom(chatRoomUserName, memberList): return __client.delete_member_from_chatroom(
    chatRoomUserName, memberList)


def add_member_into_chatroom(chatRoomUserName, memberList): return __client.add_member_into_chatroom(chatRoomUserName,
                                                                                                     memberList)
...
def send_msgTest(msg, fromUserName, toUserName=None):
    return __client.send_msgTest(msg, fromUserName, toUserName)
